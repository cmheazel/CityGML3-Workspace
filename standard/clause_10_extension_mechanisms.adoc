...
The following requirements and recommendations provide a formal definition of the CityGML Extension capabilities. Meeting these criteria are required to demonstrate conformance with the GityGML Core conformance class.

===== Generics Classes

The following Requirements govern the use of Generics classes.

include::requirements/Core/REQ_Core_Generics_Use.adoc[]
...
include::requirements/Core/REQ_Core_ADE_UML.adoc[]

include::recommendations/Core/REC_Core_ADE_UML.adoc[]

===== Classes

The following Requirements and Recommendations define how CityGML classes should be extended by an ADE.

include::requirements/Core/REQ_Core_ADE_Elements.adoc[]

include::recommendations/Core/REC_Core_ADE_Elements.adoc[]
...
include::requirements/Core/REQ_Core_ADE_Properties.adoc[]
