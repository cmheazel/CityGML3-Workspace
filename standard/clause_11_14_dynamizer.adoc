...
include::requirements/dynamizer/REQ_Dynamizer_Base.adoc[]

include::requirements/dynamizer/REQ_Dynamizer_RefIntegrity.adoc[]

include::requirements/dynamizer/REQ_Dynamizer_Restrictions.adoc[]
