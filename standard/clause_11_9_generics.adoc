...
The UML diagram of the Generics module is depicted in <<generics-uml,Generics UML Diagram>>. A detailed discussion of this Requirements Class can be found in the CityGML Best Practices document https://github.com/opengeospatial/CityGML3-Workspace/blob/master/19-072BP.html#bp_generics_section[here].
