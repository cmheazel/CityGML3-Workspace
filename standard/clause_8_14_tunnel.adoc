...
The ADE data types provided for the Tunnel module are illustrated in the figure <<tunnel-uml-ade-types>>.

[[tunnel-uml-ade-types]]
.ADE classes of the CityGML Tunnel module.
image::figures/Tunnel-ADE_Datatypes.png[]

The Code Lists provided for the Tunnel module are illustrated in the figure <<tunnel-uml-codelists>>.
