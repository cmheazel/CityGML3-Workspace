...
The ADE data types provided for the Land Use module are illustrated in the figure <<landuse-uml-ade-types>>.

[[landuse-uml-ade-types]]
.ADE classes of the CityGML Land Use module.
image::figures/LandUse-ADE_Datatypes.png[]

The Code Lists provided for the Land Use module are illustrated in the figure <<landuse-uml-codelists>>.
