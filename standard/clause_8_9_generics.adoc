...
The UML diagram of the Generics module is depicted in <<generics-uml,Generics UML Diagram>>. A detailed discussion of this Requirements Class can be found in the https://github.com/opengeospatial/CityGML3-Workspace/blob/master/19-072UG.html#bp_generics_section[CityGML Users Guide].
