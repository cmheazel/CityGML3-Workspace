...
include::requirements/requirements_class_spatial.adoc[]
...
include::requirements/Spatial_Model/REQ_Spatial_Base.adoc[]

include::requirements/Spatial_Model/REQ_Spatial_RefIntegrity.adoc[]
