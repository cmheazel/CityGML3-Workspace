...
The UML diagram of the PointCloud module is depicted in <<pointcloud-uml,Point Cloud UML Diagram>>. A detailed discussion of this Requirements Class can be found in the  https://github.com/opengeospatial/CityGML3-Workspace/blob/master/19-072UG.html#bp_pointcloud_section[CityGML User Guide].
