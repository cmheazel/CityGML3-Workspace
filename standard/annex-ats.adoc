...
CityGML 3.0 is a Conceptual Model. Since it is agnostic to implementating technologies, an Executable Test Script is not feasible. It becomes the responsiblity of the Implementation Specifications to provide evidence of conformance. This evidence should be provided as an annex to the Implementation Specification document.
