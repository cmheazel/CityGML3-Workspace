...
The UML diagram of the Dynamizer module is depicted in <<dynamizer-uml,Dynamizer UML Diagram>>. A detailed discussion of this Requirements Class can be found in the https://github.com/opengeospatial/CityGML3-Workspace/blob/master/19-072UG.html#bp_dynamizer_section[CityGML Users Guide].
