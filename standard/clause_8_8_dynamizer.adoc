...
The ADE data types provided for the Dynamizer module are illustrated in the figure <<dynamizer-uml-ade-types>>.

[[dynamizer-uml-ade-types]]
.ADE classes of the CityGML Dynamizer module.
image::figures/Dynamizer-ADE_Datatypes.png[]

The Code Lists provided for the Dynamizer module are illustrated in the figure <<dynamizer-uml-codelists>>.
