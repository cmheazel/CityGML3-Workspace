...
* Additional UML models that can be created by users to extend this conceptual model through Application Domain Extensions.
...
* Extension of conceptual model through code lists, generic objects and Application Domain Extensions (ADEs)
