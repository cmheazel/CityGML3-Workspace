...
The ADE data types provided for the Building module are illustrated in the figure <<building-uml-ade-types>>.

[[building-uml-ade-types]]
.ADE classes of the CityGML Building module.
image::figures/Building-ADE_Datatypes.png[]

The Code Lists provided for the Building module are illustrated in the figure <<building-uml-codelists>>.

[[building-uml-codelists]]
.Codelists from the CityGML Building module.
image::figures/Building-Codelists.png[]

<<building-boundaries-table>> lists the surfaces that are allowed as thematic surface boundaries of the spaces classes defined in the Building module:
