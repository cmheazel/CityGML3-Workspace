...
The UML diagram of the Vegetation module is depicted in <<vegetation-uml,Vegetation UML Diagram>>. A detailed discussion of this Requirements Class can be found in the  https://github.com/opengeospatial/CityGML3-Workspace/blob/master/19-072UG.html#bp_vegetation_section[CityGML User Guide].
