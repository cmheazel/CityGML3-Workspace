...
An alternate representation can be found in the <<conceptual-model-section,CityGML Conceptual Model>>.
...
The following packages are defined in the CityGML 3 UML model.
