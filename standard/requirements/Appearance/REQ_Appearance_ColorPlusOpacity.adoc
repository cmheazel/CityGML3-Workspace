[[req_Appearance_ColorPlusOpacity]]
[width="90%",cols="2,6"]
|===
^|*Requirement  {counter:req-id}* |*/req/Appearance/ColorPlusOpacity>* 
^|A |The Implementation Specification SHALL contain an element with the same definition as the ColorPlusOpacity UML class as documented in the ColorPlusOpacity section of the <<ColorPlusOpacity-section,Appearance Data Dictionary>>.
