...
^|A |The Implementation Specification SHALL contain an element with the same definition as the TexCoordList UML class as documented in the TexCoordList section of the <<TexCoordList-section,Appearance Data Dictionary>>.
