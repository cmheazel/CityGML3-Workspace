...
The ADE data types provided for the Bridge module are illustrated in the figure <<bridge-uml-ade-types>>.

[[bridge-uml-ade-types]]
.ADE classes of the CityGML Bridge module.
image::figures/Bridge-ADE_Datatypes.png[]

The Code Lists provided for the Bridge module are illustrated in the figure <<bridge-uml-codelists>>.
...
Additional information about the Bridge Module can be found in the link:http://docs.opengeospatial.org/DRAFTS/20-066.html[OGC CityGML 3.0 Users Guide]
