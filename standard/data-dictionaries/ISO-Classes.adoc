...
!{set:cellbgcolor:#FFFFFF} coordinate   !Sequence<Number> !
!{set:cellbgcolor:#FFFFFF} dimension   !Integer  !
!===
...
!{set:cellbgcolor:#FFFFFF} anyOther   !<<TM_TemporalPosition-section,TM_TemporalPosition>>  !
 
!{set:cellbgcolor:#FFFFFF} date8601   !<<Date-section,Date>>  !
 
!{set:cellbgcolor:#FFFFFF} time8601   !<<Time-section,Time>>  !
 
!{set:cellbgcolor:#FFFFFF} dateTime8601   !<<DateTime-section,DateTime>>  !
!===
|{set:cellbgcolor:#FFFFFF} Note: Unless otherwise specified, all attributes and rolls have the stereotype «Property»
|=== 
