:Title: OGC City Geography Markup Language (CityGML) Conceptual Model Standard
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/CityGML/3.0
|Internal reference number of this OGC(R) document:    20-010
|Version: 0.5
|Category: OGC(R) Conceptual Model
|Editors: Thomas H. Kolbe, Tatjana Kutzner, Carl Stephen Smyth, Claus Nagel, Charles Heazel, and possible further editors
|===
...
include::clause_7_general.adoc[]

include::clause_8_modularization.adoc[]

include::clause_9_spatial_model.adoc[]

include::clause_11_conceptual_model.adoc[]
