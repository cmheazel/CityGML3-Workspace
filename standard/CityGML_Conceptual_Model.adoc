...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/CityGML-1/3.0
...
include::clause_8_conceptual_model.adoc[]

include::clause_9_data-dictionary.adoc[]

include::clause_10_extension_mechanisms.adoc[]
