...
:titletext: City Geography Markup Language (CityGML) Conceptual Model Standard
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Version: 0.1
|Category: OGC(R) Abstract Specification
...
include::clause_8_appearance_model.adoc[]

include::clause_9_thematic_model.adoc[]
