...
City furniture consists of relatively small objects that usually have a stereotypical form and which function to decorate, explain, or control outdoor environments. Examples include road signs, traffic signals, bicycle racks, fountains, and benches.
