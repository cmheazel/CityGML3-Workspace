...
The UML diagram of the WaterBody module is depicted in <<waterbody-uml,Water Body UML Diagram>>. A detailed discussion of this Requirements Class can be found in the  https://github.com/opengeospatial/CityGML3-Workspace/blob/master/19-072UG.html#bp_waterbody_section[CityGML User Guide].
