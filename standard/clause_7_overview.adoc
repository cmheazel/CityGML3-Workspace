...
image::images/ModuleOverview.png[align="center"]

The CityGML conceptual model is thematically decomposed into a _Core module_ and different kinds of _extension modules_ as shown in <<figure-moduleoverview>>. The Core module (shown in green) comprises the basic concepts and components of the CityGML CM and, thus, must be implemented by any conformant system. Each red coloured module covers a specific thematic field of virtual 3D city models. 
...
* The _Generics_ module defines the concepts for generic objects, attributes, and relationships. _Versioning_ adds concepts for the representation of concurrent versions, real world object histories and feature histories. 
...
The combination of the two types of feature identifiers and bitemporal timestamps enables encoding not only the current version of a 3D city model, but also the models' entire history can be represented in CityGML and possibly exchanged within a single file.
...
Note: A superclass is the class from which many subclasses can be created.

==== Relationships between CityGML objects

In CityGML objects can be related to each other and different types of relations are distinguished. First of all, complex objects like buildings or transportation objects typically consist of parts. These parts are individual features of their own, and can even be further decomposed. Therefore, CityGML objects can form aggregation hierarchies. Some feature types are marked in the conceptual model with the stereotype _&#171;TopLevelFeatureType&#187;_. These constitute the main objects of a city model and are typically the root of an aggregation hierarchy. The information about which feature types belong to the top level is required for software packages that want to filter imports, exports, and visualizations according to the general type of a city object (e.g. only show buildings, solitary vegetation objects, and roads). CityGML Application Domain Extensions should also make use of this concept, such that software tools can learn from inspecting their conceptual schema what are the main, i.e. the top-level, feature types of the extension.
...
image::images/RecursiveAggregation.png[align="center"]
...
image::images/PrototypicShapes.png[align="center"]
...
image::images/OccupiedAndUnoccupiedSpaces.png[align="center"]
...
image::images/BuildingLODs.png[align="center"]
...
image::images/Floorplan.png[align="center"]
...
image::images/ClosureSurfaces.png[align="center"]
...
image::images/TerrainIntersectionCurves.png[align="center"]
...
The CityGML 3.0 Conceptual Model introduces two concepts to manage dynamic, time-dependent, properties of city models. The _Versioning_ module manages changes that are slower in nature:

. The history or evolution of cities such as construction or demolition of buildings, and 
. Managing multiple versions of the city models. 
...
image::images/Dynamizers.png[align="center"]
...
Additional information about the extension features of CityGML can be found in the link:http://docs.opengeospatial.org/DRAFTS/20-066.html[CityGML 3.0 Users Guide].
