[[ats_Dynamizer_TimeValuePair]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Dynamizer/TimeValuePair* 
...
^|Requirement |<<req_Dynamizer_TimeValuePair,/req/Dynamizer/rc-TimeValuePair>>
