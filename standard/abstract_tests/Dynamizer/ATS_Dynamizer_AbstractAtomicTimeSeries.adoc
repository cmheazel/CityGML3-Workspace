[[ats_Dynamizer_AbstractAtomicTimeSeries]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Dynamizer/AbstractAtomicTimeSeries* 
...
^|Requirement |<<req_Dynamizer_AbstractAtomicTimeSeries,/req/Dynamizer/rc-AbstractAtomicTimeSeries>>
