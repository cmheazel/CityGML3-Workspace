[[ats_Dynamizer_AbstractTimeSeries]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Dynamizer/AbstractTimeSeries* 
...
^|Requirement |<<req_Dynamizer_AbstractTimeSeries,/req/Dynamizer/rc-AbstractTimeSeries>>
