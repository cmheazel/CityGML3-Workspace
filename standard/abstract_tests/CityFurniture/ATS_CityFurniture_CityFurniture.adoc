[[ats_CityFurniture_CityFurniture]]
[width="90%",cols="2,6a"]
|===
...
^|A |Validate that a data element exists with the same definition as that of the CityFurniture class in the Conceptual Model 
