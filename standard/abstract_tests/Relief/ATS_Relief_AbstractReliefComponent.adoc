[[ats_Relief_AbstractReliefComponent]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Relief/AbstractReliefComponent* 
...
^|Requirement |<<req_Relief_AbstractReliefComponent,/req/Relief/rc-AbstractReliefComponent>>
