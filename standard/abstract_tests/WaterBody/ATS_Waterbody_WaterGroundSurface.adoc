[[ats_Waterbody_WaterGroundSurface]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Waterbody/WaterGroundSurface* 
^|Test Purpose |To validate that the Implementation Specification correctly implements the UML Classes defined in the Conceptual Model
^|Requirement |<<req_Waterbody_WaterGroundSurface,/req/Waterbody/rc-WaterGroundSurface>>
