[[ats_Transportation_AuxiliaryTrafficArea]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Transportation/AuxiliaryTrafficArea* 
^|Test Purpose |To validate that the Implementation Specification correctly implements the UML Classes defined in the Conceptual Model
^|Requirement |<<req_Transportation_AuxiliaryTrafficArea,/req/Transportation/rc-AuxiliaryTrafficArea>>
