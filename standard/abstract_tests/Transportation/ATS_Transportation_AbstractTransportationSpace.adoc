[[ats_Transportation_AbstractTransportationSpace]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Transportation/AbstractTransportationSpace* 
...
^|Requirement |<<req_Transportation_AbstractTransportationSpace,/req/Transportation/rc-AbstractTransportationSpace>>
