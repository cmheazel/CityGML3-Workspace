...
[width="90%",cols="2,6"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/vegetation/ade_use* 
...
^|Requirement |<<req_vegetation_ade-uses,/req/vegetation/ade_use>>
^|Test Method |Manual Inspection
2+|If any ADE classes or properties are included in the Vegetation Package:
