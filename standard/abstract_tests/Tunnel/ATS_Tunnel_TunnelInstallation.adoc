[[ats_Tunnel_TunnelInstallation]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Tunnel/TunnelInstallation* 
^|Test Purpose |To validate that the Implementation Specification correctly implements the UML Classes defined in the Conceptual Model
^|Requirement |<<req_Tunnel_TunnelInstallation,/req/Tunnel/rc-TunnelInstallation>>
