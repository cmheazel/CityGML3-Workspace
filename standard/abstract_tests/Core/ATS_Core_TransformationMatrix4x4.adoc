[[ats_Core_TransformationMatrix4x4]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Core/TransformationMatrix4x4* 
...
^|Requirement |<<req_Core_TransformationMatrix4x4,/req/Core/rc-TransformationMatrix4x4>>
