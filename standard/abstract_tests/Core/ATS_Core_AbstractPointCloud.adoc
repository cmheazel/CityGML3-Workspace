[[ats_Core_AbstractPointCloud]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Core/AbstractPointCloud* 
...
^|Requirement |<<req_Core_AbstractPointCloud,/req/Core/rc-AbstractPointCloud>>
