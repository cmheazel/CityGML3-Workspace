[[ats_Core_AbstractVersionTransition]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Core/AbstractVersionTransition* 
...
^|Requirement |<<req_Core_AbstractVersionTransition,/req/Core/rc-AbstractVersionTransition>>
