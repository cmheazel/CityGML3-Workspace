[[ats_Core_AbstractThematicSurface]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Core/AbstractThematicSurface* 
...
^|Requirement |<<req_Core_AbstractThematicSurface,/req/Core/rc-AbstractThematicSurface>>
