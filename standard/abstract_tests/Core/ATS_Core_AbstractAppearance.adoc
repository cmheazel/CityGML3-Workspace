[[ats_Core_AbstractAppearance]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Core/AbstractAppearance* 
...
^|Requirement |<<req_Core_AbstractAppearance,/req/Core/rc-AbstractAppearance>>
