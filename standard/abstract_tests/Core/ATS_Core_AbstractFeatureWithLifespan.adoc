[[ats_Core_AbstractFeatureWithLifespan]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Core/AbstractFeatureWithLifespan* 
...
^|Requirement |<<req_Core_AbstractFeatureWithLifespan,/req/Core/rc-AbstractFeatureWithLifespan>>
