[[ats_Generics_StringAttribute]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Generics/StringAttribute* 
...
^|Requirement |<<req_Generics_StringAttribute,/req/Generics/rc-StringAttribute>>
