[[ats_Generics_GenericThematicSurface]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Generics/GenericThematicSurface* 
^|Test Purpose |To validate that the Implementation Specification correctly implements the UML Classes defined in the Conceptual Model
^|Requirement |<<req_Generics_GenericThematicSurface,/req/Generics/rc-GenericThematicSurface>>
