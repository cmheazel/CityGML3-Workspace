[[ats_Generics_MeasureAttribute]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/Generics/MeasureAttribute* 
...
^|Requirement |<<req_Generics_MeasureAttribute,/req/Generics/rc-MeasureAttribute>>
