:Title: OGC City Geography Markup Language (CityGML) Conceptual Model Best Practice
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/CityGML/3.0
...
include::clause_10_appearance.adoc[]

include::clause_11_thematic_model.adoc[]
