...
[[general-modeling-principles-section]]
=== General Modelling Principles

[[semantic-modelling-section]]
...
[[class-hierarchy-and-inheritance-section]]
...
[[relationships-between-citygml-objects-section]]
...
[[definitions-of-semantics-section]]
...
[[representation-of-spatial-properties-section]]
=== Representation of Spatial Properties

[[geometry-and-topology-section]]
...
[[space-and-space-boundaries-section]]
...
[[figure-occupiedandunoccupiedspaces,Figure {counter:figure-num}]]
.Occupied and unoccupied spaces
image::../standard/images/OccupiedAndUnoccupiedSpaces.png[align="center"]
...
[[surface-orientation-of-spaces-section]]
...
[[figure-buildinglods,Figure {counter:figure-num}]]
.Representation of the same real-world building in the Levels of Detail 0-3.
image::../standard/images/BuildingLODs.png[align="center"]
...
[[figure-floorplan,Figure {counter:figure-num}]]
...
image::../standard/images/Floorplan.png[align="center"]
...
[[figure-closuresurfaces,Figure {counter:figure-num}]]
...
image::../standard/images/ClosureSurfaces.png[align="center"]

[[terrain-intersection-curves-section]]
...
[[figure-terrainintersectioncurves,Figure {counter:figure-num}]]
...
image::../standard/images/TerrainIntersectionCurves.png[align="center"]

[[coherent-modelling-section]]
...
[[versioning-and-history-section]]
