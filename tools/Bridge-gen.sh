...
ACLIST="AbstractBridge"

# The instantiatable classes
CCLIST="Bridge BridgeConstructiveElement BridgeFurniture BridgeInstallation BridgePart BridgeRoom"

# CodeLists
CLLIST="BridgeClassValue BridgeConstructiveElementClassValue BridgeConstructiveElementFunctionValue BridgeConstructiveElementUsageValue BridgeFunctionValue BridgeFurnitureClassValue BridgeFurnitureFunctionValue BridgeFurnitureUsageValue BridgeInstallationClassValue BridgeInstallationFundtionValue BridgeInstallationUsageValue BridgeRoomClassValue BridgeRoomFunctionValue BridgeRoomUsageValue BridgeUsageValue"
