...
ACLIST="AbstractVegetationObject"

# The instantiatable classes
CCLIST="PlantCover SolitaryVegetationObject"

# CodeLists
CLLIST="PlantCoverClassValue PlantCoverFunctionValue PlantCoverUsageValue SolitaryVegetationObjectClassValue SolitaryVegetationObjectFunctionValue SolitaryVegetationObjectUsageValue SpeciesValue"
