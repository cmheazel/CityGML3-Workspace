...
ACLIST="AbstractTunnel"

# The instantiatable classes
CCLIST="HollowSpace Tunnel TunnelConstructiveElement TunnelFurniture TunnelInstallation TunnelPart"

# CodeLists
CLLIST="HollowSpaceClassValue HollowSpaceFunctionValue HollowSpaceUsageValue TunnelClassValue TunnelConstructiveElementClassValue TunnelConstructiveElementFunctionValue TunnelConstructiveElementUsageValue TunnelFunctionValue TunnelFurnitureClassValue TunnelFurnitureFunctionValue TunnelFurnitureUsageValue TunnelInstallationClassValue TunnelInstallationFunctionValue TunnelInstallationUsageValue TunnelUsageValue"             
