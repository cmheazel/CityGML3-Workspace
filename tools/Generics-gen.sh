...
CCLIST="GenericLogicalSpace GenericOccupiedSpace GenericThematicSurface GenericUnoccupiedSpace"

# CodeLists
CLLIST="GenericLogicalSpaceClassValue GenericLogicalSpaceFunctionValue GenericLogicalSpaceUsageValue GenericOccupiedSpaceClassValue GenericOccupiedSpaceFunctionValue GenericOccupiedSpaceUsageValue GenericThematicSurfaceClassValue GenericThematicSurfaceFunctionValue GenericThematicSurfaceUsageValue GenericUnoccupiedSpaceClassValue GenericUnoccupiedSpaceFunctionValue GenericUnoccupiedSpaceUsageValue"  

# And Data Types
DTLIST="DateAttribute DoubleAttribute GenericAttributeSet IntAttribute MeasureAttribute StringAttribute UriAttribute"
