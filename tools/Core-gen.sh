...
# CodeLists
CLLIST="IntervalValue MimeValue OccupantTypeValue OtherRelationTypeValue QualifiedAreaValue QualifiedVolumeValue RelationTypeValue TemporalRelationTypeValue  TopologicalRelationTypeValue RelativeToTerrain RelativeToWater SpaceType"
