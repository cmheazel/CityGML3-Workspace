...
ACLIST="AbstractWaterBoundarySurface"

# The instantiatable classes
CCLIST="WaterBody WaterGroundSurface WaterSurface"

# CodeLists
CLLIST="WaterBodyClassValue WaterBodyFunctionValue WaterBodyUsageValue WaterLevelValue"
