...
CCLIST="CityFurniture"

# CodeLists
# CLLIST="CityFurnitureClassValue CityFurnitureFunctionValue CityFurnitureUsageValue"
CLLIST=" "
...
for I in $CCLIST
do
cat ./Templates/REQ_Package_Classes_Template.adoc | sed s/"CLASS"/$I/g | sed s/"PACKAGE"/$PKG/ | sed s/"REFF"/"<<"$I/ >../standard/requirements/$PKG/REQ_`echo $PKG`_$I.adoc
done
